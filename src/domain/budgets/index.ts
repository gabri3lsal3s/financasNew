...
export const CATEGORY_RULES: Record<string, CategoryRule> = {
  ...
  alimentacao: { icon: "alimentacao", color: "#F59E0B", limitPercent: 15 },
  mercado: { icon: "mercado", color: "#F59E0B", limitPercent: 15 },
  supermercado: { icon: "mercado", color: "#F59E0B", limitPercent: 15 },
  restaurante: { icon: "alimentacao", color: "#F59E0B", limitPercent: 10 },
  ...
  educacao: { icon: "educacao", color: "#10B981", limitPercent: 10 },
  curso: { icon: "educacao", color: "#10B981", limitPercent: 10 },
  escola: { icon: "educacao", color: "#10B981", limitPercent: 10 },
  faculdade: { icon: "educacao", color: "#10B981", limitPercent: 10 },
