  ...
  return (
    <>
      ...
      <button
        ...
        title="Calculadora"
        className="fixed z-40 flex items-center justify-center rounded-full bg-primary-strong text-primary-foreground shadow-lg transition-transform active:scale-95"
