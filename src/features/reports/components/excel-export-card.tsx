...
export function ExcelExportCard({ workbookData }: ExcelExportCardProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-2xl border border-portfolio/30 bg-portfolio/5 p-4 sm:p-5 shadow-xs">
      <div className="flex items-center gap-3.5">
        <span className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-portfolio/10 border border-portfolio/20 text-portfolio">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Exportação completa em 5 abas (Resumo Patrimonial, Custódia de Ativos, Proventos, DRE e Dívidas) com formatações e fórmulas nativas.
          </p>
        </div>
      </div>
      <Button
