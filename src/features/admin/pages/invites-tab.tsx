...
export function InvitesTab() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 rounded-2xl border border-portfolio/30 bg-portfolio/5 shadow-xs">
        <div className="flex items-center gap-3">
          <span className="flex size-10 items-center justify-center rounded-xl bg-portfolio/10 border border-portfolio/20 text-portfolio">
            <KeyRound className="size-5" aria-hidden="true" />
          </span>
          <div className="flex flex-col">
            <span className="text-sm font-bold text-foreground">Gestão de Convites &amp; Allowlist</span>
            <span className="text-xs text-muted-foreground">
              Cadastros realizados com convite válido são ativados automaticamente no primeiro acesso.
            </span>
          </div>
        </div>
