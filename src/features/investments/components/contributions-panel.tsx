...
/**
 * Painel inline de histórico de aportes por mês (§F37).
 * Reutiliza a mesma lógica do antigo ContributionsListDialog,
 * mas sem wrapper de Modal — adequado para uso em sub-aba.
 */
