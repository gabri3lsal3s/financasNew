...
| **F20** | Sistema de Gestos & Navegação por Swipe (Trilha A) | Engine `useSwipeNavigation` (axis-lock ±30°, thresholds/flick, isolamento, **edge inset 24px** + arming 1.5), `MonthSwiper` nas 5 telas de mês, `Tabs swipeable` nas 6 telas de abas, feedback elástico | Gesture UX mobile |
