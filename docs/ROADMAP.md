...
| 18 | **F32** — Recorrências, Rendas Parceladas & Operações em Grupo | A / Transações | F2/F21/F25 | 📋 Pronta para Execução (proposta 2026-08-17 — ver seção Fase 32 abaixo) |

### Fase 32 — Recorrências, Rendas Parceladas & Operações em Grupo

> **Status:** 📋 Proposta (2026-08-17) — planejamento aprovado; aguardando execução (Etapas 1–7).
