...
npm run test         # vitest — 1084 testes (140 arquivos)
...
- ✅ **Testes:** 1084 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1084 testes + build — ✅ produção
