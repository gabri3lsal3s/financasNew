...
npm run test         # vitest — 1126 testes (143 arquivos)
...
- ✅ **Testes:** 1126 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias, atualizações otimistas, gestos).
...
[x] Deploy verde: typecheck + lint + 1126 testes + build — ✅ produção
