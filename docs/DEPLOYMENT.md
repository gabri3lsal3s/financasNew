...
npm run test         # vitest — 1092 testes (139 arquivos)
...
- ✅ **Testes:** 1092 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1092 testes + build — ✅ produção
