...
npm run test         # vitest — 1073 testes (139 arquivos)
...
- ✅ **Testes:** 1073 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1073 testes + build — ✅ produção
