...
npm run test         # vitest — 1075 testes (140 arquivos)
...
- ✅ **Testes:** 1075 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1075 testes + build — ✅ produção
