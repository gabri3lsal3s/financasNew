...
npm run test         # vitest — 1093 testes (140 arquivos)
...
- ✅ **Testes:** 1093 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1093 testes + build — ✅ produção
