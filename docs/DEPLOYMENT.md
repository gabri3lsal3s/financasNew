...
- ✅ **Testes:** 1135 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias, atualizações otimistas, gestos, impressão/PrintSheet).
...
[x] Deploy verde: typecheck + lint + 1135 testes + build — ✅ produção
