...
npm run test         # vitest — 1087 testes (140 arquivos)
...
- ✅ **Testes:** 1087 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1087 testes + build — ✅ produção
