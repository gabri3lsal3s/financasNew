...
npm run test         # vitest — 1114 testes (143 arquivos)
...
- ✅ **Testes:** 1114 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias, atualizações otimistas).
...
[x] Deploy verde: typecheck + lint + 1114 testes + build — ✅ produção
