...
npm run test         # vitest — 1091 testes (140 arquivos)
...
- ✅ **Testes:** 1091 verdes (domínio puro, RPCs, telas, a11y com axe, teclado, deep-links, auditorias).
...
[x] Deploy verde: typecheck + lint + 1091 testes + build — ✅ produção
