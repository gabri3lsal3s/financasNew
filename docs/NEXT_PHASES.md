...
**Pré-requisitos transversais:** suíte de testes verde + typecheck/lint/build · deploy F1.7 (edge function + cron) se P1 = (a) · sem migrations obrigatórias fora de P4 = (c).
