...
F32 (Recorrências, Rendas Parceladas)      ← Trilha A / Transações (📋 Proposta 2026-08-17)
```
...
## 6. FASE 32 — RECORRÊNCIAS, RENDAS PARCELADAS & OPERAÇÕES EM GRUPO (PROPOSTA 2026-08-17)

> Planejamento completo aprovado (2026-08-17) — ver `ROADMAP.md` §3 (Fase 32). Na execução, atualizar `ESPECIFICACAO_TECNICA.md` (§3.1, §3.2.5 e novo §3.2.7), `PROJECT_STRUCTURE.md` e `ARCHITECTURE.md`.
